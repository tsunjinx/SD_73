...
const activityLogs = ref([
  {
    ...
    id_nguoi_dung: 1,
    hanh_dong: 'login',
    mo_ta: 'Đăng nhập thành công vào hệ thống từ trình duyệt Chrome',
    thoi_gian: '2023-12-21T08:30:00Z',
  ...
  },
  {
    id: 2,
    id_nguoi_dung: 2,
    hanh_dong: 'create_order',
    mo_ta: 'Tạo đơn hàng mới HD001 cho khách hàng Nguyễn Văn An với tổng giá trị 2,500,000 VND',
    thoi_gian: '2023-12-21T09:15:00Z',
  ...
  },
  {
    id: 3,
    id_nguoi_dung: 3,
    hanh_dong: 'update_product',
    mo_ta: 'Cập nhật thông tin sản phẩm Nike Air Max 270 - thay đổi giá từ 2,200,000 VND thành 2,500,000 VND',
    thoi_gian: '2023-12-21T10:45:00Z',
  ...
  },
  {
    id: 4,
    id_nguoi_dung: 1,
    hanh_dong: 'view_report',
    mo_ta: 'Xem báo cáo doanh thu tháng 12/2023 - tổng doanh thu: 150,000,000 VND',
    thoi_gian: '2023-12-21T11:20:00Z',
    ip_address: '192.168.1.100',
    nguoi_dung: {
      ho_ten: 'Nguyễn Văn Admin',
      vai_tro: 'Quản trị viên'
  ...
  },
  {
    ...
    mo_ta: 'Đăng nhập thất bại - sai mật khẩu (lần thử thứ 3)',
    thoi_gian: '2023-12-21T12:00:00Z',
    ip_address: '203.162.14.155',
    nguoi_dung: {
      ho_ten: 'Unknown User',
      vai_tro: 'N/A'
    }
  },
  {
    id: 6,
    id_nguoi_dung: 3,
    hanh_dong: 'create_customer',
    mo_ta: 'Tạo thông tin khách hàng mới: Phạm Thị Hương - Email: phamhương@email.com - SĐT: 0912345678',
    thoi_gian: '2023-12-21T13:30:00Z',
    ip_address: '192.168.1.110',
    nguoi_dung: {
      ho_ten: 'Lê Văn Staff',
      vai_tro: 'Nhân viên'
  ...
  },
  {
    id: 7,
    id_nguoi_dung: 1,
    hanh_dong: 'system_backup',
    mo_ta: 'Thực hiện sao lưu hệ thống tự động - Backup file: backup_20231221.sql',
    thoi_gian: '2023-12-21T14:00:00Z',
  ...
  },
  {
    id: 8,
    id_nguoi_dung: 2,
    hanh_dong: 'export_data',
    mo_ta: 'Xuất dữ liệu đơn hàng tháng 12/2023 - format Excel, tổng 1,250 đơn hàng',
    thoi_gian: '2023-12-21T15:15:00Z',
    ip_address: '192.168.1.105',
    nguoi_dung: {
      ho_ten: 'Trần Thị Manager',
      vai_tro: 'Quản lý'
  ...
  },
  {
    id: 9,
    id_nguoi_dung: 1,
    hanh_dong: 'update_order',
    mo_ta: 'Cập nhật trạng thái đơn hàng HD001 từ "Chờ xác nhận" thành "Đã giao hàng"',
    thoi_gian: '2023-12-21T16:00:00Z',
    ip_address: '192.168.1.100',
    nguoi_dung: {
      ho_ten: 'Nguyễn Văn Admin',
      vai_tro: 'Quản trị viên'
  ...
  },
  {
    ...
    id_nguoi_dung: 3,
    hanh_dong: 'logout',
    mo_ta: 'Đăng xuất khỏi hệ thống',
    thoi_gian: '2023-12-21T17:30:00Z',
    ip_address: '192.168.1.110',
    nguoi_dung: {
      ho_ten: 'Lê Văn Staff',
      vai_tro: 'Nhân viên'
