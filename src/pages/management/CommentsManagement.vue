...
const comments = ref([
  {
    ...
    id_san_pham: 1,
    id_nguoi_dung: 1,
    noi_dung: 'Giày rất đẹp và chất lượng tốt. Đi rất êm chân, thiết kế hiện đại. Tôi rất hài lòng với sản phẩm này và sẽ giới thiệu cho bạn bè. Dịch vụ giao hàng cũng nhanh chóng và chu đáo.',
    ngay_binh_luan: '2023-12-20T10:30:00Z',
    trang_thai: true,
    san_pham: {
      ten_san_pham: 'Nike Air Max 270',
      thuong_hieu: 'Nike',
      hinh_anh: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400',
      gia_ban: 2500000
    },
    nguoi_dung: {
  ...
  },
  {
    ...
    id_san_pham: 2,
    id_nguoi_dung: 2,
    noi_dung: 'Chất lượng tạm được nhưng giá hơi cao so với mặt bằng chung. Tuy nhiên design khá đẹp và phù hợp cho tập gym.',
    ngay_binh_luan: '2023-12-19T14:15:00Z',
    trang_thai: null,
    san_pham: {
      ten_san_pham: 'Adidas Ultraboost 22',
      thuong_hieu: 'Adidas',
      hinh_anh: 'https://images.unsplash.com/photo-1605348532760-6753d2c43329?w=400',
      gia_ban: 3200000
    },
    nguoi_dung: {
  ...
  },
  {
    ...
    id_san_pham: 3,
    id_nguoi_dung: 3,
    noi_dung: 'Giày cổ điển, phù hợp với nhiều outfit. Giao hàng nhanh chóng.',
    ngay_binh_luan: '2023-12-21T09:00:00Z',
    trang_thai: true,
    san_pham: {
      ten_san_pham: 'Converse Chuck Taylor',
      thuong_hieu: 'Converse',
      hinh_anh: 'https://images.unsplash.com/photo-1607522370275-f14206abe5d3?w=400',
      gia_ban: 1800000
    },
    nguoi_dung: {
  ...
  },
  {
    ...
    id_san_pham: 4,
    id_nguoi_dung: 4,
    noi_dung: 'Không hài lòng với sản phẩm. Chất liệu kém, dễ bị rách sau vài lần sử dụng.',
    ngay_binh_luan: '2023-12-18T16:45:00Z',
    trang_thai: false,
    san_pham: {
      ten_san_pham: 'Vans Old Skool',
      thuong_hieu: 'Vans',
      hinh_anh: 'https://images.unsplash.com/photo-1543508282-6319a3e2621f?w=400',
      gia_ban: 2200000
    },
    nguoi_dung: {
      ho_ten: 'Phạm Thị Lan',
  ...
  },
  {
    ...
    id_san_pham: 1,
    id_nguoi_dung: 5,
    noi_dung: 'Sản phẩm tốt, đúng mô tả. Sẽ mua thêm.',
    ngay_binh_luan: '2023-12-22T11:20:00Z',
    trang_thai: null,
    san_pham: {
      ten_san_pham: 'Nike Air Max 270',
      thuong_hieu: 'Nike',
